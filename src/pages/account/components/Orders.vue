<template>
  <main class="">
    ...
    <NuxtLink
      to="/"
      class="mt-6 inline-flex items-center justify-center px-4 py-2 text-sm shadow-sm focus-visible:outline-2 focus-visible:outline-offset-2 btn-primary-solid"
    >
      ALLER À LA BOUTIQUE
    </NuxtLink>
  </main>
