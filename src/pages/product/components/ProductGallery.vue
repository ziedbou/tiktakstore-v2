<template>
  <div>
    <div class="w-full md:sticky md:top-24 max-md:mt-5">
    <div v-if="loading" class="animate-pulse">
      <div
        class="relative overflow-hidden rounded-lg mb-4 bg-gray-200 aspect-square"
      >
        <div class="w-full h-full bg-gray-300"></div>
        <div
          class="absolute left-3 top-1/2 -translate-y-1/2 bg-gray-300 rounded-full p-2 shadow-md w-10 h-10"
        ></div>
        <div
          class="absolute right-3 top-1/2 -translate-y-1/2 bg-gray-300 rounded-full p-2 shadow-md w-10 h-10"
        ></div>
        <div
          class="absolute right-3 top-3 bg-gray-300 rounded-full p-2 shadow-md w-10 h-10"
        ></div>
      </div>
    ...
    <div v-else>
      <div
        class="relative overflow-hidden md:rounded-lg mb-4 bg-gray-50 w-full items-center justify-center flex h-[400px] md:h-[550px]"
      >
        <div
        ...
        >
          <div v-if="item.type === 'image' || !item.type" class="h-full">
            <NuxtImg
              :src="imghttps(item.src)"
              :alt="item.alt"
              class="w-fit h-full  max-h-[400px] md:max-h-[550px] mx-auto object-contain !rounded-xl"
            />
          </div>
          <video
      ...
      <ClientOnly>
        <div class="mb-4 mx-2 max-w-[96%] w-fit mx-auto">
          <Swiper
            ref="swiperRef"
            ...
            >
              <button
                ...
                :class="[
                  ...
                  index === currentImageIndex
                    ? 'border-2 border-[var(--btn-primary-solid-background)] scale-95'
      ...
      >
        ...
        >
          <div
            class="relative w-4xl h-[75vh] md:h-[90vh] bg-white rounded-lg shadow-2xl overflow-hidden"
            @click.stop
          >
            <button
              @click="closeModal"
            ...
            >
              ...
              >
                <img
                  ...
                  class="h-full mx-auto object-contain !rounded-xl"
                />
                <video
