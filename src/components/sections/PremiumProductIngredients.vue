<template>
  <div
    ...
    :style="{
      ...
      '--product-description-color': data.values.product_description_color,
    }"
  >
...
.ingredients-item-image img,
.ingredients-item-image svg {
  display: block;
  width: 100%;
  height: 100%;
  object-fit: cover;
